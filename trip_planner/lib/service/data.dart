...
Future<Database> getDatabase() async {
  final database = openDatabase(
    join(await getDatabasesPath(), 'trip_planner7.db'),
...
// insert tours
      ...
      await db.insert('tours', {
        ...
        'schedule': 'NIGHT 1: HO CHI MINH CITY - BUSAN (OVERNIGHT ON PLANE) \n'
      ...
      await db.insert('tours', {
        ...
        'schedule': 'NIGHT 01: SAIGON - KANSAI (OVERNIGHT ON PLANE) \n'
      ...
      await db.insert('tours', {
        ...
        'schedule': 'NIGHT 01: HO CHI MINH CITY - NARITA \n'
